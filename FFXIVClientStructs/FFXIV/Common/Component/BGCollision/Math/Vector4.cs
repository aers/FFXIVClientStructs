...
public struct Vector4 : IEquatable<Vector4>, IFormattable {
    ...
    public static Vector4 Transform(Vector2 position, Common.Math.Matrix4x4 matrix) {
        return new Vector4(
    ...
    public static Vector4 Transform(Common.Math.Vector3 position, Common.Math.Matrix4x4 matrix) {
        return new Vector4(
    ...
    public static Vector4 Transform(Common.Math.Vector3 value, Quaternion rotation) {
        var x2 = rotation.X + rotation.X;
        var y2 = rotation.Y + rotation.Y;
        var z2 = rotation.Z + rotation.Z;
    ...
    public static Vector4 Transform(Vector4 vector, Common.Math.Matrix4x4 matrix) {
        return new Vector4(
