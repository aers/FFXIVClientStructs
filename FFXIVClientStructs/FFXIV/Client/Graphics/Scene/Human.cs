...
public unsafe partial struct Human
{
    ...
    [FieldOffset(0x904)] [Obsolete("Use Customize.LipColorFurPattern")] public byte LipColorFurPattern;
    [FieldOffset(0x90C)] public uint SlotNeedsUpdateBitfield;
    [FieldOffset(0x910)] [IDAIgnore] public fixed byte EquipSlotData[4 * 0xA];
