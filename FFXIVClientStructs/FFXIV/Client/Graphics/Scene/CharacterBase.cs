...
public unsafe partial struct CharacterBase {
    ...
    [FieldOffset(0x1B8)][Experimental("UnknownField")] public ModelRenderer.Callback UnkCallback3;
    ...
    [FieldOffset(0x278)][Experimental("UnknownField")] public ConstantBuffer* UnkCBuffer; // Size is also 0xB0
