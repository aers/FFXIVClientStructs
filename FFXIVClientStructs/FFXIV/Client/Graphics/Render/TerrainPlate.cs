...
// Client::Graphics::Render::TerrainPlate
...
public unsafe partial struct TerrainPlate {
    ...
    [FieldOffset(0x40)] private void* ModelThingBufferPtr; // An array of things corresponding to something in the ModelResourceHandle.
    [FieldOffset(0x48)] private uint ModelThingBufferLength;
