...
public unsafe struct RenderTargetManager
{
	...
	public unsafe struct KnownRenderTargetsStruct
	{
		// specific ones i can name
		// offscreen renderer is used to render models for UI elements like the character window
		[FieldOffset(0x1C0)] public Texture* OffscreenRenderTarget_1;
		[FieldOffset(0x1C8)] public Texture* OffscreenRenderTarget_2;
		[FieldOffset(0x1D0)] public Texture* OffscreenRenderTarget_3;
		[FieldOffset(0x1D8)] public Texture* OffscreenRenderTarget_4;
		[FieldOffset(0x1E0)] public Texture* OffscreenGBuffer;
		[FieldOffset(0x1E8)] public Texture* OffscreenDepthStencil;

		[FieldOffset(0x1F0)] public Texture* OffscreenRenderTarget_Unk1; // these are related to offscreen renderer due to their size

		[FieldOffset(0x1F8)] public Texture* OffscreenRenderTarget_Unk2;
		[FieldOffset(0x200)] public Texture* OffscreenRenderTarget_Unk3;		
	}
    ...
    [FieldOffset(0x20)] KnownRenderTargetsStruct KnownRenderTargets;
