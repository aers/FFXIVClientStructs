...
public struct Vector3 : IEquatable<Vector3>, IFormattable {
    ...
    public static Vector3 TransformCoordinate(Vector3 coordinate, Matrix44 matrix) {
    ...
    public static Vector3 Project(Vector3 vector, float x, float y, float width, float height, float minZ, float maxZ, Matrix44 projectionMatrix) {
    ...
    public static Vector3 Unproject(Vector3 vector, float x, float y, float width, float height, float minZ, float maxZ, Matrix44 projectionMatrix) {
	    var v = new Vector3 {
		    X = (vector.X - x) / width * 2.0f - 1.0f,
		    Y = -((vector.Y - y) / height * 2.0f - 1.0f),
		    Z = (vector.Z - minZ) / (maxZ - minZ)
	    };
	    Matrix44.Invert(projectionMatrix, out var matrix);
    ...
    public static implicit operator global::System.Numerics.Vector3(Vector3 v) => new(v.X, v.Y, v.Z);
    public static implicit operator Vector3(global::System.Numerics.Vector3 v) => new(v.X, v.Y, v.Z);
