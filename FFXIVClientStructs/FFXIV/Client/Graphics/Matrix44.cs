...
public unsafe struct Matrix44 : IEquatable<Matrix44> {
	...
	public static readonly Matrix44 Zero = new(0.0f);
	public static readonly Matrix44 Identity = new() { M11 = 1.0f, M22 = 1.0f, M33 = 1.0f, M44 = 1.0f };
	...
	public static bool Decompose(Matrix44 matrix, out Vector3 scale, out Quaternion rotation, out Vector3 translation) {
	...
	public static Matrix44 Lerp(Matrix44 start, Matrix44 end, float amount) {
		return LerpUnclamped(start, end, Math.Clamp(amount, 0.0f, 1.0f));
	}

	public static Matrix44 LerpUnclamped(Matrix44 start, Matrix44 end, float amount) {
		return start + (end - start) * amount;
	}

	public static Matrix44 SmoothStep(Matrix44 start, Matrix44 end, float amount) {
	...
	public static implicit operator global::System.Numerics.Matrix4x4(Matrix44 matrix) => *(global::System.Numerics.Matrix4x4*)&matrix;
    public static implicit operator Matrix44(global::System.Numerics.Matrix4x4 matrix) => *(Matrix44*)&matrix;

    public static Matrix44 operator +(Matrix44 a, Matrix44 b) => global::System.Numerics.Matrix4x4.Add(a, b);
    public static Matrix44 operator -(Matrix44 a, Matrix44 b) => global::System.Numerics.Matrix4x4.Subtract(a, b);
    public static Matrix44 operator -(Matrix44 a) => global::System.Numerics.Matrix4x4.Negate(a);
    public static Matrix44 operator *(Matrix44 a, Matrix44 b) => global::System.Numerics.Matrix4x4.Multiply(a, b);
    public static Matrix44 operator *(Matrix44 a, float b) => global::System.Numerics.Matrix4x4.Multiply(a, b);
