...
public unsafe partial struct PVShader {
    ...
    [FieldOffset(0x38)][Experimental("UnknownField")] public ResourceEntry* Unknowns;
    [FieldOffset(0x40)] public ushort ConstantBufferCount;
    [FieldOffset(0x44)] public ushort SamplerCount;
    [FieldOffset(0x48)][Experimental("UnknownField")] public ushort UnkCount;
    [FieldOffset(0x4C)][Experimental("UnknownField")] public ushort Unk2Count;
