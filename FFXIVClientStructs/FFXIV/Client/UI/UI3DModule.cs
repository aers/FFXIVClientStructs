...
public unsafe partial struct UI3DModule {
    ...
    [FieldOffset(0x20), FixedSizeArray] internal FixedSizeArray819<ObjectInfo> _objectInfos; // array of Client::UI::UI3DModule::ObjectInfo
    [FieldOffset(0x13340), FixedSizeArray] internal FixedSizeArray819<Pointer<ObjectInfo>> _sortedObjectInfoPointers; // array of Client::UI::UI3DModule::ObjectInfo*, distance sorted(?)
    [FieldOffset(0x14CD8)] public int SortedObjectInfoCount;
    ...
    [FieldOffset(0x15350), FixedSizeArray] internal FixedSizeArray68<Pointer<ObjectInfo>> _mapObjectInfoPointers; // array of Client::UI::UI3DModule::ObjectInfo* for objects displayed on minimap - summoning bells, mailboxes, etc
    [FieldOffset(0x15570)] public int MapObjectInfoCount;
    [FieldOffset(0x15578)] public ObjectInfo* TargetObjectInfo;
    ...
    [FieldOffset(0x15E90), FixedSizeArray][Experimental("UnknownField")] internal FixedSizeArray30<UnkInfo> _unkInfoArray;
    [FieldOffset(0x16610)][Experimental("UnknownField")] public int UnkCount;
    ...
    public partial struct MapInfo {
        ...
        [FieldOffset(0x12)][Experimental("UnknownField")] public byte Unk_12;
    }
    ...
    public partial struct ObjectInfo {
        ...
        [FieldOffset(0x48)][Experimental("UnknownField")] public uint Unk_48;
        ...
        [FieldOffset(0x50)][Experimental("UnknownField")] public byte Unk_50;
    ...
    public partial struct MemberInfo {
        ...
        [FieldOffset(0x20)][Experimental("UnknownField")] public byte Unk_20;
        // rest unknown
    }
