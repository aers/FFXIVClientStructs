...
public unsafe partial struct AddonJobHud {
    [FieldOffset(0x238)][Experimental("UnknownField")] public byte Unk220;
    [FieldOffset(0x239)] public bool UseSimpleGauge;
    [FieldOffset(0x23A)][Experimental("UnknownField")] public byte Unk222;
    ...
    [FieldOffset(0x248)] public AddonJobHudGauge* GaugeSimplePointer;
    [FieldOffset(0x250)] public AddonJobHudGaugeData* DataPreviousPointer;
    [FieldOffset(0x258)] public AddonJobHudGaugeData* DataCurrentPointer; // Current is always used to apply updates, and then copied onto Previous. The two are compared to detect changes.

    [FieldOffset(0x260)] public AtkResNode* JobHudRootNode;
