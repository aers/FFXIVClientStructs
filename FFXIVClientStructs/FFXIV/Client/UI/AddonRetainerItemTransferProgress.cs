...
public unsafe partial struct AddonRetainerItemTransferProgress {
    [FieldOffset(0x230)] public AtkTextNode* EntrustAllItemsButton; // Node 2
    [FieldOffset(0x238)] public AtkComponentButton* CloseWindowButton; // Node 9
    [FieldOffset(0x240)] public AtkResNode* ProgressBar; // Node 7
    [FieldOffset(0x248)] public ushort Progress; // Node 7
}
