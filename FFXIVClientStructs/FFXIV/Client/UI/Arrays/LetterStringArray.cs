...
public unsafe partial struct LetterStringArray {
    ...
    /// </summary>
    [FieldOffset(0 * 8), FixedSizeArray, CExportIgnore] internal FixedSizeArray130<CStringPointer> _mailSenders;

    /// <summary>
    /// Ordered based on date received. It doesn't care about which tab.
    /// </summary>
    [FieldOffset(130 * 8), FixedSizeArray, CExportIgnore] internal FixedSizeArray130<CStringPointer> _timesPassed;

    /// <summary>
    /// Ordered based on date received. It doesn't care about which tab.
    /// </summary>
    [FieldOffset(260 * 8), FixedSizeArray, CExportIgnore] internal FixedSizeArray130<CStringPointer> _mailTextPreviews;
