...
public unsafe partial struct LetterNumberArray {
    ...
    public unsafe partial struct LetterLetterNumberArray {
        ...
        [FieldOffset(2)][Experimental("UnknownField")] public byte UnkFlag1;
        [FieldOffset(1)][Experimental("UnknownField")] public byte UnkFlag2;
        [FieldOffset(0)][Experimental("UnknownField")] public byte UnkFlag3;  // This is definitely some kind of, user grabbed items, user opened type flag that sends a web request.
