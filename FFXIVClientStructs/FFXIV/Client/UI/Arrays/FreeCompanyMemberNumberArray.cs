...
public unsafe partial struct FreeCompanyMemberNumberArray {
    ...
    [FieldOffset(0 * 4), FixedSizeArray, CExportIgnore] internal FixedSizeArray200<SocialListMemberNumberArray> _freeCompanyMembers;

    [FieldOffset(2606 * 4), FixedSizeArray, CExportIgnore] internal FixedSizeArray200<int> _freeCompanyMemberMemoSortIndexes;
}
