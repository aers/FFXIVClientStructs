...
public unsafe partial struct NamePlateNumberArray {
    ...
    // [FieldOffset(5 * 4)][Experimental("UnknownField")] public int UnkInt;
    ...
    public struct NamePlateObjectIntArrayData {
        ...
        // [FieldOffset(14 * 4)][Experimental("UnknownField")] public int UnkAdjust;
        [FieldOffset(15 * 4)] public int NamePlateObjectIndex;
        // [FieldOffset(16 * 4)][Experimental("UnknownField")] public int Unk;
        /// <summary>
        ...
        // [FieldOffset(18 * 4)][Experimental("UnknownField")] public int Unk;
        /// <summary>
