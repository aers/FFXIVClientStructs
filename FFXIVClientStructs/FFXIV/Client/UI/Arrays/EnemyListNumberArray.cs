...
public unsafe partial struct EnemyListNumberArray {
    ...
    [FieldOffset(0 * 4)][Experimental("UnknownField")] public int Unk0;
    [FieldOffset(1 * 4)] public int EnemyCount;
    [FieldOffset(2 * 4)] public int TargetEntityId;
    [FieldOffset(3 * 4)][Experimental("UnknownField")] public int UnkEntityId;
    [FieldOffset(4 * 4)][Experimental("UnknownField")] public int Unk4;
    ...
    public partial struct EnemyListEnemyNumberArray {
        ...
        [FieldOffset(5 * 4)][Experimental("UnknownField")] public int Unk5;
    }
}
