...
public unsafe partial struct AreaMapNumberArray {
    ...
    // [FieldOffset(4 * 4)][Experimental("UnknownField")] public int UnkInt; // Always a zero it seems
    // [FieldOffset(5 * 4)][Experimental("UnknownField")] public int UnkInt; // Always a zero it seems
}
