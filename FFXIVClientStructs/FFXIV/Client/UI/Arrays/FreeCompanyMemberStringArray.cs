...
public unsafe partial struct FreeCompanyMemberStringArray {
    ...
    [FieldOffset(0 * 8), FixedSizeArray, CExportIgnore] internal FixedSizeArray200<SocialListMemberStringArray> _members;

    [FieldOffset(1000 * 8)] public CStringPointer YourMemo;

    [FieldOffset(1001 * 8), FixedSizeArray, CExportIgnore] internal FixedSizeArray200<FreeCompanyMemoStringArray> _memos;
