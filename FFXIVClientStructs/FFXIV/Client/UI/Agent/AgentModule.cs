...
public enum AgentId : uint {
    ...
    LoadingTips = 168,
    Revive = 169,
    GoldSaucerHud = 170, // controls LovmStatus, LovmConfirm, LovmReady or RaceChocoboStatus, RaceChocoboConfirm, RaceChocoboReady
    ChocoboRace = 171,
    ChocoboBreed = 172,
    ...
    MKDSettings = 483,
    MKDTowerEntry = 484,
    MKDLore = 485, // new in 7.2 - interacts with agents MKDLoreBook, MKDInfo
    MKDLoreBook = 486,
    MKDRelicGrowth = 487,
    MKDRelicGrowth2 = 488,
    MKDRelicGrowth3 = 489,
