...
public unsafe partial struct AgentSalvage {
    ...
    // [FieldOffset(0x384)][Experimental("UnknownField")] public uint Unknown1; // 0x79 before desynth
    // [FieldOffset(0x38C)][Experimental("UnknownField")] public uint Unknown2; // 0x79 after desynth

    [FieldOffset(0x390)] public InventoryItem DesynthItemSlot;
    [FieldOffset(0x3D8)] public Utf8String TextQuantity;
    // [FieldOffset(0x440)][Experimental("UnknownField")] public byte Unknown3; // 0xC8
