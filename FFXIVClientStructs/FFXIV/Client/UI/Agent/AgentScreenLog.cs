...
namespace FFXIVClientStructs.FFXIV.Client.UI.Agent
{
    ...
    public unsafe partial struct AgentScreenLog
    {
        ...
        [FieldOffset(0x378)] public byte BalloonsHaveUpdate; // bool used to know if any balloons have been added/changed since last frame update
        [FieldOffset(0x37C)] public int BalloonCounter; // count of all balloons since game launch, used as unique balloon ID
