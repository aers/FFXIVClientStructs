...
public unsafe partial struct AgentDeepDungeonInspect {
    ...
    public unsafe partial struct AgentDeepDungeonInspectData {
        ...
        //[FieldOffset$3][Experimental("UnknownFunction")] public uint Unk0C;
        ...
        //[FieldOffset$3][Experimental("UnknownFunction")] public byte Unk81; //Always 0 (solo in PotD)
        [FieldOffset(0x82)] public byte WorldId;
        //[FieldOffset$3][Experimental("UnknownFunction")] public byte Unk83; //Always 0 (solo in PotD)
        //[FieldOffset$3][Experimental("UnknownFunction")] public byte Unk84; //Always 1 (solo in PotD)
        ...
        //[FieldOffset$3][Experimental("UnknownFunction")] public Utf8String UnkF8; //Never seen a value here. Type taken from Constructor
    }
}
