...
namespace FFXIVClientStructs.FFXIV.Client.UI.Agent {
    ...
    public unsafe partial struct AgentContext {
        public static AgentContext* Instance() => (AgentContext*)Framework.Instance()->GetUiModule()->GetAgentModule()->GetAgentByInternalId(AgentId.Context);
        ...
        [FieldOffset(0x1730)] public void* UpdateChecker; // AgentContextUpdateChecker*, if handler returns false the menu closes
        [FieldOffset(0x1738)] public long UpdateCheckerParam; //objectid of the target or list index of an addon or other things
