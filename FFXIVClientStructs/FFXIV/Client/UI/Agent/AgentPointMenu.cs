...
public unsafe partial struct AgentPointMenu {
    ...
    [FieldOffset(0x40)] private uint DefaultChoice;
    ...
    public struct PointMenuContext {
        ...
        [FieldOffset(0x138)] public int PointMenuId;
        [FieldOffset(0x13C)] public bool IsLoaded;
    }

    [StructLayout(LayoutKind.Explicit, Size = 0x88)]
    public struct PointMenuEntry {
        [FieldOffset(0x00), CExporterExcelBegin("PointMenuChoice")] public float X;
        ...
        [FieldOffset(0x18)] public ushort PointMenuStringId;
        [FieldOffset(0x1A)] public byte Shape;
        [FieldOffset(0x1B)] private byte IsElliptical; // is what???
        [FieldOffset(0x1C)] public byte NavUp;
        [FieldOffset(0x1D)] public byte NavDown;
        [FieldOffset(0x1E)] public byte NavLeft;
        [FieldOffset(0x1F), CExporterExcelEnd] public byte NavRight;
