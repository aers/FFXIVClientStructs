...
public unsafe partial struct AgentShop {
    ...
    [FieldOffset(0x98)] public CStringPointer ShopName; // only for SpecialShop ?
    ...
    public struct ShopItem {
        ...
        //[FieldOffset$3][Experimental("UnknownFunction")] public Utf8String UnkString1;
        //[FieldOffset$3][Experimental("UnknownFunction")] public Utf8String UnkString2;
        ...
        //[FieldOffset$3][Experimental("UnknownFunction")] public uint Unk210;
        [FieldOffset(0x214)] public uint ItemCount;
        [FieldOffset(0x218)] public uint OwnedItemCount;
        [FieldOffset(0x21C)] public uint ItemId;
        //[FieldOffset$3][Experimental("UnknownFunction")] public uint Unk220;
