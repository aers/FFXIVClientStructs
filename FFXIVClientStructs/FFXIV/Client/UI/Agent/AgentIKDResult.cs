...
// Client::UI::Agent::AgentIKDResult
...
public unsafe partial struct AgentIKDResult {
    ...
    public struct ContentBonusEntry {
        ...
        [FieldOffset(0xD8)][Experimental("UnknownField")] public ushort UnkUShort; //IKDContentBonus Column 2
    ...
    public struct CatchResultInfo {
        ...
        [FieldOffset(0x08)][Experimental("UnknownField")] public byte UnkByte; //FishParameter Column 3

        [FieldOffset(0x09)] public byte IKDContentBonusId;
        //[FieldOffset$3][Experimental("UnknownFunction")] public ushort UnkUShort;
    }
}
