...
public unsafe partial struct AgentIKDResult {
	...
	public unsafe partial struct ResultData {
		...
		// PlayerResult, but unpacked
		[FieldOffset(0x310)] public Utf8String PlayerName;
		[FieldOffset(0x378)] public ushort WorldId;
		[FieldOffset(0x37C)] public ushort TotalCaught;
