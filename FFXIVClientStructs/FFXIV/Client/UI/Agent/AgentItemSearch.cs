...
public unsafe partial struct AgentItemSearch {
    ...
    [FieldOffset(0x33A4), Obsolete("Use ResultHoveredItem.GetSlot()", true)] public ushort ResultHoveredIndex;
    [FieldOffset(0x33A8), Obsolete("Use ResultHoveredItem.GetItemId()/GetBaseItemId()", true)] public uint ResultHoveredItemId;
    [FieldOffset(0x33AC), Obsolete("Use ResultHoveredItem.GetQuantity()", true)] public uint ResultHoveredCount;
    [FieldOffset(0x33B4), Obsolete("Use ResultHoveredItem.IsHighQuality()", true)] public byte ResultHoveredHQ;
