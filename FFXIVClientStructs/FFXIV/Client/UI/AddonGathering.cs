...
public unsafe partial struct AddonGathering {
    [FieldOffset(0x238)] private AtkResNode* UnkResNode230;
    ...
    [FieldOffset(0x288)] private AtkResNode* UnkResNode280;
    [FieldOffset(0x290)] public AtkTextNode* IntegrityLeftover;
    [FieldOffset(0x298)] private AtkResNode* UnkResNode290;
    [FieldOffset(0x2A0)] public AtkTextNode* IntegrityTotal;
    [FieldOffset(0x2A8)] private AtkResNode* UnkResNode2A0;
    [FieldOffset(0x2B0)] public AtkTextNode* InventoryQuantityTextNode;
    [FieldOffset(0x2B8)] private AtkResNode* UnkResNode2B0;
    [FieldOffset(0x2C0)] public AtkComponentCheckBox* QuickGatheringComponentCheckBox;
    [FieldOffset(0x2C8)] private AtkResNode* UnkResNode2C0;
    ...
    [MemberFunction("E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 80 B9 ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 48 8B 84 24 ?? ?? ?? ??")]
    public partial void NotifyQuickGatherState();
}
