...
public unsafe partial struct AddonGathering {
    [FieldOffset(0x238)][Experimental("UnknownField")] public AtkResNode* UnkResNode230;
    ...
    [FieldOffset(0x288)][Experimental("UnknownField")] public AtkResNode* UnkResNode280;
    [FieldOffset(0x290)] public AtkTextNode* IntegrityLeftover;
    [FieldOffset(0x298)][Experimental("UnknownField")] public AtkResNode* UnkResNode290;
    [FieldOffset(0x2A0)] public AtkTextNode* IntegrityTotal;
    [FieldOffset(0x2A8)][Experimental("UnknownField")] public AtkResNode* UnkResNode2A0;
    [FieldOffset(0x2B0)] public AtkTextNode* InventoryQuantityTextNode;
    [FieldOffset(0x2B8)][Experimental("UnknownField")] public AtkResNode* UnkResNode2B0;
    [FieldOffset(0x2C0)] public AtkComponentCheckBox* QuickGatheringComponentCheckBox;
    [FieldOffset(0x2C8)][Experimental("UnknownField")] public AtkResNode* UnkResNode2C0;
