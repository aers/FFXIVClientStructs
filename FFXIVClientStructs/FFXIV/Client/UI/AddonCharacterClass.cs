...
[VirtualTable("48 8D 05 ?? ?? ?? ?? 48 89 03 0F 57 C0 48 89 93 ?? ?? ?? ?? 48 8D 83 ?? ?? ?? ?? 48 89 93 ?? ?? ?? ?? 45 33 C0", 3, 74)]
...
public unsafe partial struct AddonCharacterClass {
    ...
    [FieldOffset(0x358)] public AtkTextNode* CurrentDesynthesisLevelTextNode;
    [FieldOffset(0x360)] public AtkTextNode* MaxDesynthesisLevelTextNode;
    [FieldOffset(0x368), FixedSizeArray] internal FixedSizeArray33<ClassEntry> _classEntries;

    [FieldOffset(0x8A0)] public int TabIndex;
