...
public unsafe partial struct AddonActionBarX {
    ...
    [FieldOffset(0x27C), FixedSizeArray] internal FixedSizeArray6<Dimensions> _layoutDimensions; // every hotbar stores the same pre-baked dimensions for each of the 6 layout options
