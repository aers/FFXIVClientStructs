...
public unsafe partial struct McAggreModule {
    ...
    [FieldOffset(0x48)][Experimental("UnknownField")] public int UnkTimestamp; // read/write as long though
    ...
    [FieldOffset(0x2C0)][Experimental("UnknownField")] public byte Unk2C0;
    [FieldOffset(0x2C1)][Experimental("UnknownField")] public byte Unk2C1;
}
