...
public unsafe partial struct PerformanceModule {
    ...
    [FieldOffset(0x48)][Experimental("UnknownField")] public ushort Unk48; // Version presumably. If 0, it migrates AssignAllNotesToKeyboard from FlagStatusModule or something like that.
