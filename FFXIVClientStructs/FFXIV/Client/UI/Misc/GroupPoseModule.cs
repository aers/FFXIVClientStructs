...
public unsafe partial struct GroupPoseModule {
    ...
    // [FieldOffset(0x48)][Experimental("UnknownField")] public byte Unk40;
    // [FieldOffset(0x49)][Experimental("UnknownField")] public byte Unk41;

    // [FieldOffset(0x4C)][Experimental("UnknownField")] public float Unk44;
    // [FieldOffset(0x50)][Experimental("UnknownField")] public float Unk48;
    [FieldOffset(0x54)] public float CameraAngle; // 0.5 to -0.5
    // [FieldOffset(0x58)][Experimental("UnknownField")] public float Unk50;
    // [FieldOffset(0x5C)][Experimental("UnknownField")] public float Unk54;
