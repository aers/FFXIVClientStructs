...
public unsafe partial struct EmjModule {
    ...
    [FieldOffset(0x4C)][Experimental("UnknownField")] public byte Unk4C;
    [FieldOffset(0x4D)][Experimental("UnknownField")] public byte Unk4D;
    ...
    [FieldOffset(0x54)][Experimental("UnknownField")] public byte Unk54;
    [FieldOffset(0x55)][Experimental("UnknownField")] public byte Unk55;

    [FieldOffset(0x58)][Experimental("UnknownField")] public int Unk58;
    [FieldOffset(0x5C)][Experimental("UnknownField")] public int Unk5C; // set to current time
