...
public unsafe partial struct MinionListModule {
    ...
    // [FieldOffset(0x48)][Experimental("UnknownField")] public byte Unk40; // set to 1 in ReadFile
    ...
    // [FieldOffset(0x9A)][Experimental("UnknownField")] public uint Unk92;
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 49 8B 4E ?? ?? ?? ?? FF 50 ?? 49 8B 8E ?? ?? ?? ?? BA")]
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 4C 8B 8B ?? ?? ?? ?? 4C 8D 44 24 ?? 49 83 C1")]
