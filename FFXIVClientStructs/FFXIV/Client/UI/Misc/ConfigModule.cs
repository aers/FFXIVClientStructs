...
public unsafe partial struct ConfigModule {
    ...
    public struct Option {
        [FieldOffset(0x00)][Experimental("UnknownField")] public void* Unk00;
        [FieldOffset(0x08)][Experimental("UnknownField")] public ulong Unk08;
        [FieldOffset(0x10)] public ConfigOption OptionId;
        [FieldOffset(0x14)][Experimental("UnknownField")] public uint Unk14;
        [FieldOffset(0x18)][Experimental("UnknownField")] public uint Unk18;
        [FieldOffset(0x1C)][Experimental("UnknownField")] public ushort Unk1C;
