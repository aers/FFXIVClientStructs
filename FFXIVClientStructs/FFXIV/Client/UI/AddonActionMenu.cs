...
public unsafe partial struct AddonActionMenu {
    ...
    // [FieldOffset(0x1508)][Experimental("UnknownField")] public AtkTextNode* UnknownText;
    // [FieldOffset(0x1510)][Experimental("UnknownField")] public AtkComponentNode* UnknownNode; // Appears to be the first action node in the new action view? Not sure.
