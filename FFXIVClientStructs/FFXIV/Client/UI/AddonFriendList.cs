...
public unsafe partial struct AddonFriendList {
    ...
    [FieldOffset(0x318)] public AtkComponentCheckBox* MoveOnlineToTopCheckBox;
    [FieldOffset(0x320)] public AtkTextNode* CurrentFriendCountTextNode; // current / limit, ie '13/200'
    [FieldOffset(0x328)] public AtkTextNode* ListIsEmptyTextNode;
    [FieldOffset(0x338)] public AtkComponentDropDownList* FilterDropDownList;
    [FieldOffset(0x340)] public AtkComponentDropDownList* SortDropDownList;
