...
public unsafe partial struct InfoProxyCommonList {
    [FieldOffset(0x38)][Experimental("UnknownField")] public Utf8String UnkString;
    ...
    [FieldOffset(0xA6)][Experimental("UnknownField")] public ushort UnkA6; //10 * DataSize
    [FieldOffset(0xA8)][Experimental("UnknownField")] public ushort UnkA8; //10 * DataSize
    ...
    //[FieldOffset$3][Experimental("UnknownFunction")] public uint UnkAC; // Some kind of flag mask for OnlineStatus check InfoProxyCommonlist_vf14
