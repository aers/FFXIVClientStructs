...
public unsafe partial struct InfoProxyItemSearch {
    ...
    // [FieldOffset(0x24)][Experimental("UnknownField")] public byte Unk_0x24; // ?
    // [FieldOffset(0x25)][Experimental("UnknownField")] public byte Unk_0x25; // ?
    // [FieldOffset(0x28)][Experimental("UnknownField")] public byte Unk_0x28;
    ...
    // [FieldOffset(0x5B96)][Experimental("UnknownField")] public byte Unk_0x5B96; // controls if AddData gets called? (ResultsPresent?)
...
public unsafe partial struct MarketBoardListing {
    ...
    // [FieldOffset(0x00)][Experimental("UnknownField")] public Utf8String Unk_0x00;
    ...
    // [FieldOffset(0xAC)][Experimental("UnknownField")] public ushort Unk_0xAC;
...
public struct PlayerRetainerInfo {
    ...
    // [FieldOffset(0x0A)][Experimental("UnknownField")] public byte Unk_0x0A;

    // [FieldOffset(0x0C)][Experimental("UnknownField")] public int Unk_0x0C; // Some kind of timestamp?
