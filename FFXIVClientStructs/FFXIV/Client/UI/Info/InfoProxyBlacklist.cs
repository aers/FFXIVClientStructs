...
public unsafe partial struct InfoProxyBlacklist {
    ...
    [FieldOffset(0x19F0)] public int BlockedCharactersCount;
    [FieldOffset(0x19F8)] public StdMap<ulong, int> AccountIdMap;
    [FieldOffset(0x1A08)] public StdMap<ulong, int> ContentIdMap;
    ...
    public struct BlockedCharacter {
        ...
        [FieldOffset(0x10)] public ulong Id; // accountId for new, contentId for old
        [FieldOffset(0x18)] public byte Flag;
    }
