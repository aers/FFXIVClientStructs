...
public unsafe partial struct AddonDtr {
    ...
    // [FieldOffset(0x370)][Experimental("UnknownField")] public int unknown; // Some kind of pre-calculated size, might only update when one of the containers needs to be shown.
}
