...
public unsafe struct SqPackIndexHeader {
    ...
    [FieldOffset(0x10), FixedSizeArray] internal FixedSizeArray20<byte> _indexDataHash;
    ...
    [FieldOffset(0x5C), FixedSizeArray] internal FixedSizeArray20<byte> _synonymDataHash;
    [FieldOffset(0x9C)] public uint EmptyBlockDataOffset;
    [FieldOffset(0xA0)] public uint EmptyBlockDataSize;
    [FieldOffset(0xA4), FixedSizeArray] internal FixedSizeArray20<byte> _emptyBlockDataHash;
    [FieldOffset(0xE4)] public uint DirIndexDataOffset;
    [FieldOffset(0xE8)] public uint DirIndexDataSize;
    [FieldOffset(0xEC), FixedSizeArray] internal FixedSizeArray20<byte> _dirIndexDataHash;
    [FieldOffset(0x12C)] public uint IndexType;
    [FieldOffset(0x130)] private fixed byte Reserved[656];
    [FieldOffset(0x3C0), FixedSizeArray] internal FixedSizeArray20<byte> _selfHash;
}
