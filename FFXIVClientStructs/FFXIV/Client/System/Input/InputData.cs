...
public partial struct Keybind {
    [FieldOffset(0x00), FixedSizeArray] internal FixedSizeArray2<Keybinding> _bindings;
    [FieldOffset(0x04), FixedSizeArray] internal FixedSizeArray2<Keybinding> _controllerBindings;
