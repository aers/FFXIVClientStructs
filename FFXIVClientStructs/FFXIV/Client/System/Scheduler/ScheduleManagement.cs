...
public unsafe partial struct ScheduleManagement {
    [StaticAddress("48 8B 0D ?? ?? ?? ?? 48 85 C9 74 0E E8 ?? ?? ?? ?? 84 C0 40 0F B6 FF 0F 44 FE 48 8B 8B ?? ?? ?? ??", 3, isPointer: true)]
    public static partial ScheduleManagement* Instance();

    [FieldOffset(0x38)] public CutSceneController* CutSceneController;
