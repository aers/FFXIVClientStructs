...
public unsafe partial struct PacketDispatcher {
    ...
    [MemberFunction("48 89 5C 24 18 55 48 8D AC 24 60 FC FF FF")]
    public static partial void HandleLookingForGroupDetailPacket(uint targetId, LookingForGroupDetailPacket* packet);    
