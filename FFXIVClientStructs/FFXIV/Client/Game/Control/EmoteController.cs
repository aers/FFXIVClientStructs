...
public unsafe partial struct EmoteController {
    ...
    [FieldOffset(0x16)][Experimental("UnknownField")] public ushort Unk1; // Seems to be 1 when close enough to a target that height adjustment is needed, maybe.
    ...
    public partial struct PlayEmoteOption {
        ...
        [FieldOffset(0x11)][Experimental("UnknownField")] public bool Unk11;
