...
public unsafe partial struct CameraManager {
    ...
    [FieldOffset(0x18), Obsolete("Renamed to SpectatorCamera", true)] public Camera3* Camera3;
    [FieldOffset(0x18), Obsolete("Renamed to AimingCamera", true)] public Camera4* Camera4;
