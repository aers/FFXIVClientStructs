...
[StructLayout(LayoutKind.Explicit, Size = 0x44C0)] //could be bigger
public unsafe partial struct Control
{
    ...
    [FieldOffset(0x44A8)] public uint LocalPlayerObjectId;
    [FieldOffset(0x44B0)] public BattleChara* LocalPlayer;
