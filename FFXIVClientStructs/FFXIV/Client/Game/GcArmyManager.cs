...
public unsafe partial struct GcArmyMember {
    ...
    [FieldOffset(0x44)] public byte Stain1MainHand;
    [FieldOffset(0x45)] public byte Stain1OffHand;
    [FieldOffset(0x46)] public byte Stain1Head;
    [FieldOffset(0x47)] public byte Stain1Body;
    [FieldOffset(0x48)] public byte Stain1Hands;
    [FieldOffset(0x49)] public byte Stain1Legs;
    [FieldOffset(0x4A)] public byte Stain1Feet;
