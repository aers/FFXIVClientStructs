...
public unsafe partial struct GcArmyManager {
    [StaticAddress("48 8B 05 ?? ?? ?? ?? 0F 29 B4 24 ?? ?? ?? ?? 0F 29 BC 24 ?? ?? ?? ?? 44 0F 29 84 24 ?? ?? ?? ?? 48 85 C0", 3, isPointer: true)]
...
public unsafe partial struct GcArmyMember {
    ...
    [FieldOffset(0x44)] public byte Stain0MainHand;
    [FieldOffset(0x45)] public byte Stain0OffHand;
    [FieldOffset(0x46)] public byte Stain0Head;
    [FieldOffset(0x47)] public byte Stain0Body;
    [FieldOffset(0x48)] public byte Stain0Hands;
    [FieldOffset(0x49)] public byte Stain0Legs;
    [FieldOffset(0x4A)] public byte Stain0Feet;
    [FieldOffset(0x4B)] public byte Stain1MainHand;
    [FieldOffset(0x4C)] public byte Stain1OffHand;
    [FieldOffset(0x4D)] public byte Stain1Head;
    [FieldOffset(0x4E)] public byte Stain1Body;
    [FieldOffset(0x4F)] public byte Stain1Hands;
    [FieldOffset(0x50)] public byte Stain1Legs;
    [FieldOffset(0x51)] public byte Stain1Feet;
