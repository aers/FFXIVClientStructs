...
public unsafe partial struct PublicContentEureka {
    [FieldOffset(0x1380)] private ushort Unk1090; // if set, prints log message 9068 in chat ("Character progression enhancement will be applied to all participants in this duty.")
    [FieldOffset(0x1382)] private ushort Unk1092; // if set, prints log message 4217 in chat ("To facilitate the successful completion of this duty, you have been granted the power of the Echo.")
    ...
    [FieldOffset(0x1540)] private Utf8String Unk1250;
}
