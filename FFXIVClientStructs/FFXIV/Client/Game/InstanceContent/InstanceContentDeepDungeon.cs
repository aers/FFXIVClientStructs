...
[StructLayout(LayoutKind.Explicit, Size = 0x2928)]
public unsafe partial struct InstanceContentDeepDungeon {
    [FieldOffset(0x1E90), FixedSizeArray] internal FixedSizeArray4<DeepDungeonPartyInfo> _party;
    [FieldOffset(0x1EB0), FixedSizeArray] internal FixedSizeArray16<DeepDungeonItemInfo> _items;
    [FieldOffset(0x1EE0), FixedSizeArray] internal FixedSizeArray16<DeepDungeonChestInfo> _chests;
    [FieldOffset(0x1F00), FixedSizeArray] internal FixedSizeArray3<byte> _magicite;

    [FieldOffset(0x1F08)] public uint BonusLootItemId;
    [FieldOffset(0x1F0C)] public byte Floor;
    [FieldOffset(0x1F0D)] public byte ReturnProgress;
    [FieldOffset(0x1F0E)] public byte PassageProgress;

    [FieldOffset(0x1F10)] public byte WeaponLevel;
    [FieldOffset(0x1F11)] public byte ArmorLevel;
    [FieldOffset(0x1F12)] public byte SyncedGearLevel;
    [FieldOffset(0x1F13)] public byte HoardCount;

    [FieldOffset(0x28D6)] public byte DeepDungeonId; // 1-3

    [FieldOffset(0x2908), FixedSizeArray] internal FixedSizeArray25<RoomFlags> _mapData;
    ...
    [FieldOffset(0x2922)] public byte ActiveLayoutIndex;
    // seen values:
    // 1 - normal
    // 6 - in boss arena
    [FieldOffset(0x2923)] public byte LayoutInitializationType;
