...
[StructLayout(LayoutKind.Explicit, Size = 0x3200)]
public unsafe partial struct PublicContentBozja {
    [FieldOffset(0x1388)] public DynamicEventContainer DynamicEventContainer;
    [FieldOffset(0x3108)] public BozjaState State;
    [FieldOffset(0x31F8)] public bool StateInitialized;
