...
public unsafe partial struct GameObject {
    ...
    // [FieldOffset(0x140)][Experimental("UnknownField")] public Vector3 Unk140; // something SharedGroupLayoutInstance related
    // [FieldOffset(0x150)][Experimental("UnknownField")] public uint Unk150; // something QuestRedo related
    [FieldOffset(0x158)] public LuaActor* LuaActor;
    [FieldOffset(0x160)] public EventHandler* EventHandler;
    // [FieldOffset(0x168)][Experimental("UnknownField")] public float Unk168; // ModelChara.Unknown3 * 0.1f
