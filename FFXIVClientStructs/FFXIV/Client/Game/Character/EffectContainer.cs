...
public unsafe partial struct EffectContainer {
    ...
    // [FieldOffset(0x1C)][Experimental("UnknownField")] public float UnkSpeed;
    // [FieldOffset(0x20)][Experimental("UnknownField")] public int UnkTime;
    // [FieldOffset(0x24)][Experimental("UnknownField")] public byte UnkRidingPillionFlag;
    // [FieldOffset(0x26)][Experimental("UnknownField")] public short UnkRidingPillionValue;
    // [FieldOffset(0x2C)][Experimental("UnknownField")] public float UnkTime2;
    ...
    // [FieldOffset(0x3C)][Experimental("UnknownField")] public byte Unk3C;
