...
public unsafe partial struct Achievement {
    ...
    [FieldOffset(0x0C), FixedSizeArray(false, true, 3901)] internal FixedSizeArray488<byte> _completedAchievements;

    /// <remarks> Last Five Achievement Ids </remarks>
    [FieldOffset(0x1FE), FixedSizeArray] internal FixedSizeArray5<ushort> _history;
    // [FieldOffset(0x208), FixedSizeArray] internal FixedSizeArray32<byte> _unk1FC; // BitArray, index is Achievement.Unknown1 or Unknown2
    [FieldOffset(0x224)] public AchievementState ProgressRequestState;
    [FieldOffset(0x228)] public uint ProgressAchievementId;
    [FieldOffset(0x22C)] public uint ProgressCurrent;
    [FieldOffset(0x230)] public uint ProgressMax;

    // Stuff for "Near Completion" tab and some other unimplemented tab, idk?
    // [FieldOffset(0x236)] 2x byte for opened state?
    // [FieldOffset(0x238)] 2x AchievementState
    // [FieldOffset(0x240)] 2x struct 0x1E5 length with each 3x struct of 0x80 that contains an array of 100 bytes???

    // [FieldOffset(0x60A), FixedSizeArray] internal FixedSizeArray479<byte> _completedItemBarterWarningAchievements; // unsure, currently only for Phantom weapons?!
