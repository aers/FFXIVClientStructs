...
public unsafe partial struct Map {
    ...
    [FieldOffset(0xB8), FixedSizeArray] internal FixedSizeArray30<MarkerInfo> _questMarkers;
    [FieldOffset(0x1198), FixedSizeArray] internal FixedSizeArray16<MarkerInfo> _levequestMarkers;

    [FieldOffset(0x1AA0)] public MarkerInfo ActiveLevequestMarker; // Marker for active levequest mission, it has to be actually started.

    [FieldOffset(0x1B38)] public StdList<MarkerInfo> UnacceptedQuestMarkers;

    [FieldOffset(0x1B80)] public StdList<MarkerInfo> GuildLeveAssignmentMarkers;

    [FieldOffset(0x1BC8)] public StdList<MarkerInfo> GuildOrderGuideMarkers;
    [FieldOffset(0x1BD8), FixedSizeArray] internal FixedSizeArray62<MarkerInfo> _housingMarkers;// 60 Plots + 2 Apartments
    [FieldOffset(0x3EB8)] public StdList<MarkerInfo> TripleTriadMarkers;
    [FieldOffset(0x3EC8)] public StdList<MarkerInfo> CustomTalkMarkers;

    [FieldOffset(0x3F70)] public StdList<MarkerInfo> GemstoneTraderMarkers;
