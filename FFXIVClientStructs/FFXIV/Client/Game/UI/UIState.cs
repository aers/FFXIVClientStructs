...
[StructLayout(LayoutKind.Explicit, Size = 0x1791C)] // its at least this big, may be a few bytes bigger
public unsafe partial struct UIState {
    ...
    [FieldOffset(0x3860)] public AreaInstance AreaInstance; // at vtbl - 0x10
