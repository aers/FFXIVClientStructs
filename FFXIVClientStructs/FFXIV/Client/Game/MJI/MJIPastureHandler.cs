...
public unsafe partial struct MJIPastureHandler {
    ...
    /// </summary>
    [FieldOffset(0x260)] public StdMap<uint, StdPair<uint, uint>> AnimalToLeavingItemIds;

    /// <summary>
    /// Per-item totals of uncollected leavings.
    /// Key is Item sheet row id, value is total amount for all animals.
    /// </summary>
    [FieldOffset(0x280)] public StdMap<uint, int> AvailableMammetLeavings;

    /// <summary>
    /// An array representing all animals currently present in the pastures on the Island. 
    /// </summary>
    [FieldOffset(0x290), FixedSizeArray] internal FixedSizeArray20<MJIAnimal> _MJIAnimals;
