...
public unsafe partial struct MJIPastureHandler {
    ...
    /// </summary>
    [FieldOffset(0x280)] public StdMap<uint, StdPair<uint, uint>> AnimalToLeavingItemIds;

    /// <summary>
    /// Per-item totals of uncollected leavings.
    /// Key is Item sheet row id, value is total amount for all animals.
    /// </summary>
    [FieldOffset(0x290)] public StdMap<uint, int> AvailableMammetLeavings;

    /// <summary>
    /// An array representing all animals currently present in the pastures on the Island. 
    /// </summary>
    [FieldOffset(0x2A0), FixedSizeArray] internal FixedSizeArray20<MJIAnimal> _MJIAnimals;
    ...
    [FieldOffset(0x6B0), FixedSizeArray] internal FixedSizeArray512<bool> _roamingMinions;
    ...
    /// </summary>
    [FieldOffset(0x8B0), FixedSizeArray] internal FixedSizeArray50<MJIMinionSlot> _minionSlots;

    // 0xB00: substructure describing currently captured animal, if there are no slots available; size is at least 8
