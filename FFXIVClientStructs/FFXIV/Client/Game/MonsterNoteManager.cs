...
public unsafe partial struct MonsterNoteManager {
    [StaticAddress("48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 84 C0 B8 ?? ?? ?? ?? 0F 45 F8", 3)]
...
public unsafe partial struct MonsterNoteRankInfo {
    ...
    [FieldOffset(0x34)][Experimental("UnknownField")] public int Unknown2; // Suspected to be some kind of flags?
    [FieldOffset(0x38)] public int Index;
    [FieldOffset(0x3C)][Experimental("UnknownField")] public int Unknown3; // Seems to be zero padding
}
