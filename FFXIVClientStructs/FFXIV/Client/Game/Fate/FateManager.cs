...
public unsafe partial struct FateManager {
    ...
    [FieldOffset(0x00)][Experimental("UnknownField")] public StdVector<GameObjectId> Unk_Vector;
    [FieldOffset(0x18)][Experimental("UnknownField")] public Utf8String Unk_String;
