...
public unsafe partial struct WKSCosmoManager {
    ...
    [FieldOffset(0xDC0)] private void* UnkStructDC0; // size: 0x6FD0
    [FieldOffset(0xDC8)] private void* UnkStructDC8; // size: 0x10
    [FieldOffset(0xDD0)] private void* UnkStructDD0; // size: 0x90
    [FieldOffset(0xDD8)] private void* UnkStructDD8; // size: 0x258
    ...
    [FieldOffset(0xDF8)] private void* UnkStructDF8; // size: 0x80
