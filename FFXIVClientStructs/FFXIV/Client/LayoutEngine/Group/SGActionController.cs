...
public unsafe partial struct SGActionController {
    ...
    [MemberFunction("48 81 EC ?? ?? ?? ?? 4C 8B CA 48 85 D2 0F 84 ?? ?? ?? ?? 48 8B 51 ?? 48 85 D2 0F 84 ?? ?? ?? ?? 48 8B 82 ?? ?? ?? ?? 41 0F B6 49 ?? 48 89 9C 24 ?? ?? ?? ?? ?? ?? ?? ?? 48 8B CA C7 44 24 ?? 00 00 00 00 C7 44 24 ?? 00 00 00 00 F3 0F 10 43 ?? F3 0F 11 44 24 ?? F3 0F 10 4B ?? F3 0F 11 4C 24 ?? F3 0F 10 43 ?? F3 0F 11 44 24 ?? 0F 10 4B")]
