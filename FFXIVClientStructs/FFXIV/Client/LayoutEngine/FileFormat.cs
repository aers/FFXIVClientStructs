...
public unsafe struct FileLayerGroupLayer {
    ...
    [FieldOffset(0x18)] public ushort FestivalId;
    [FieldOffset(0x1A)] public ushort FestivalSubId;
...
public unsafe struct FileLayerGroupInstance {
...
public unsafe struct FileLayerGroupInstanceBgPart {
    public enum Collider { None, Mesh, Analytic }

    [FieldOffset(0x00)] public FileLayerGroupInstance FileLayerGroupInstance;
...
public unsafe struct FileLayerGroupInstancePrefab {
    [FieldOffset(0x00)] public FileLayerGroupInstance FileLayerGroupInstance;
...
public unsafe struct FileLayerGroupInstanceCollider {
    [FieldOffset(0x00)] public FileLayerGroupInstance FileLayerGroupInstance;
    [FieldOffset(0x30)] public ColliderType Type;
    //[FieldOffset(0x34)] public ushort u34;
    [FieldOffset(0x36)] public bool ActiveByDefault;
}

[StructLayout(LayoutKind.Explicit, Size = 0x54)]
public unsafe struct FileLayerGroupInstanceColliderGeneric {
    [FieldOffset(0x00)] public FileLayerGroupInstanceCollider FileLayerGroupInstanceCollider;
    [FieldOffset(0x3C)] public uint MaterialMaskLow;
    [FieldOffset(0x40)] public uint MaterialIdLow;
    [FieldOffset(0x44)] public uint MaterialMaskHigh;
    [FieldOffset(0x48)] public uint MaterialIdHigh;
