...
public unsafe partial struct SteamApi {
    ...
    /// </summary>
    /// <param name="fieldXPosition">The X coordinate of the top left of the focused text field.</param>
    /// <param name="fieldYPosition">The Y coordinate of the top left of the focused text field. </param>
