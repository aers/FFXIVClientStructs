...
/// </summary>
public partial struct SteamTypes {
...
public unsafe partial struct SteamInterfaceContext {
    ...
    /// </summary>
    public T* GetInterface<T>() where T : unmanaged {
