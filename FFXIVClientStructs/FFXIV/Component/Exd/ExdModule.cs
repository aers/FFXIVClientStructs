...
public unsafe partial struct ExdModule {
    ...
    public partial void* GetEntryByIndex(uint sheetId, uint rowId); // TODO: rename to GetRowBySheetIndexAndRowIndex

    [MemberFunction("48 89 5C 24 ?? 57 48 83 EC 40 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 44 24 ?? 41 8B F8")]
    public partial void* GetSheetRowById(void* sheet, uint rowId); // TODO: rename to GetRowBySheetAndRowIndex
