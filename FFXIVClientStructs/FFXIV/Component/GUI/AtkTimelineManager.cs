...
public unsafe struct AtkTimelineManager {
    ...
    [FieldOffset(0x0C)][Experimental("UnknownField")] public uint UnkC;
    [FieldOffset(0x10)] public AtkTimeline* Timelines;
    [FieldOffset(0x18)] public ushort TimelineCount2;
    [FieldOffset(0x1C)][Experimental("UnknownField")] public uint Unk1C;
    ...
    [FieldOffset(0x50)][Experimental("UnknownField")] public ulong Unk50;
}
