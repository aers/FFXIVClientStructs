...
public unsafe partial struct AtkComponentListItemPopulator {
    ...
    public delegate void PopulateDelegate(AtkUnitBase* unitBase, int listItemIndex, AtkResNode** nodeList);
    ...
    [FieldOffset(0x10)] public delegate* unmanaged<AtkUnitBase*, int, AtkResNode**, void> Populate;
    ...
    public partial AtkComponentListItemPopulator* Ctor(AtkUnitBase* unitBase, delegate* unmanaged<AtkUnitBase*, int, AtkResNode**, void> populate);
}
