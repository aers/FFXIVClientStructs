...
public unsafe partial struct AtkComponentGaugeBar : ICreatable<AtkComponentGaugeBar> {
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 48 8B D8 E9 ?? ?? ?? ?? 45 33 C9 33 D2 B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 85 C0 0F 84 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 48 89 58 ?? 89 58 ?? 48 89 58 ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 66 89 98 ?? ?? ?? ?? 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 88 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 48 89 98 ?? ?? ?? ?? 89 98")]
