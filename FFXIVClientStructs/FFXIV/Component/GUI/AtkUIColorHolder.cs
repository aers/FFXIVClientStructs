...
public unsafe partial struct AtkUIColorHolder {
    ...
    public struct UIColor {
        ...
        [FieldOffset(0x4)][Experimental("UnknownField")] public uint Unknown0; // this field is used by GetColor() when useThemeColor is false or ActiveColorThemeType == 0
        [FieldOffset(0x8)][Experimental("UnknownField")] public uint Unknown1; // this field is used by GetColor() when useThemeColor is true and ActiveColorThemeType != 0
    }
