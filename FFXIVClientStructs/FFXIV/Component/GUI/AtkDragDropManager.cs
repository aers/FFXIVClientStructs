...
public unsafe partial struct AtkDragDropPayloadContainer {
    ...
    [FieldOffset(0x08)][Experimental("UnknownField")] public ulong Unk8;
...
public enum DragDropType : uint {
    ...
    MYCTemporaryItem = 41,
    Glasses = 42,
    QuickPanel = 43, // QuickPanelSetting
    EquipmentSlot = 44, // used as AcceptedType in Character, ArmouryBoard. presumably slot-filtered
    Unknown45 = 45,
    ActionBar_Macro = 46,
    ActionBar_Action = 47,
    ActionBar_Emote = 48,
    ...
    ActionBar_PetAction = 61,
    ActionBar_Mount = 62,
    ActionBar_FieldMarker = 63,
    ActionBar_Recipe = 64,
    Unknown65 = 65,
    Unknown66 = 66,
    Unknown67 = 67,
    ActionBar_ExtraCommand = 68,
    ActionBar_QuickChat = 69,
    Unknown70 = 70,
    ActionBar_BgcArmyAction = 71,
    Unknown72 = 72,
    ActionBar_Perform = 73,
    ActionBar_McGuffin = 74,
    ActionBar_Ornament = 75,
    ActionBar_MYCTemporaryItem = 76,
    ActionBar_Glasses = 77,
    ActionBar_QuickPanel = 78,
    Unknown79 = 79,
    Unknown80 = 80,
    AOZNotebook_Action = 81,
    Unknown82 = 82,
    Macro_Text = 83, // used as AcceptedType. you can drag items, spells etc. onto the text box and it will insert the name, or the /-command for emotes and markers
    Unknown84 = 84,
    Inventory_Item = 85, // used as AcceptedType
    Inventory_Crystal = 86, // used as AcceptedType
    RemoteInventory_Item = 87, // used as AcceptedType. Retainer, InventoryBuddy
    Unknown88 = 88,
    Unknown89 = 89,
    LetterEditor_Item = 90 // used as AcceptedType
}
