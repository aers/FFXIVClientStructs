...
public unsafe partial struct AtkMessageBoxManager {
    ...
    [FieldOffset(0x88)][Experimental("UnknownField")] public byte Unk88;
    [FieldOffset(0x89)][Experimental("UnknownField")] public byte Unk89;
    [FieldOffset(0x8A)][Experimental("UnknownField")] public byte Unk8A;
