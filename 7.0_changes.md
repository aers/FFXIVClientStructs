Last updated as of: 9487036f9ba1443421caee403786b5bb21800a3d
...
### GcArmyManager
* Added `Stain2` fields for equipment parts.
...
### AgentItemComp
* Updated `CompareItem` method to include `stain1Id` and `stain2Id`.
