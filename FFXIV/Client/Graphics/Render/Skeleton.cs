...
namespace FFXIVClientStructs.FFXIV.Client.Graphics.Render
{
    ...
    public unsafe struct Skeleton
    {
        ...
        [FieldOffset(0x58)] public void** SKLBArray; // Client::System::Resource::Handle::SkeletonResourceHandle pointer array, size = PartialSkeletonCount
        // 60: unk
        [FieldOffset(0x68)] public void* PartialSkeletonArray; // Client::Graphics::Animation::PartialSkeleton array, size = PartialSkeletonCount
