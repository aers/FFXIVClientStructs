...
enum Client_Game_Event_EventHandlerType /* Size=0x2 */
{
    Quest = 1,
    Warp = 2,
    GatheringPoint = 3,
...
enum Client_Game_QuestManager_QuestListArray_Quest_QuestFlags /* Size=0x1 */
{
    None = 0,
    Priority = 1,
    Hidden = 8
...
enum Client_Game_RetainerManager_RetainerList_RetainerTown /* Size=0x1 */
{
    LimsaLominsa = 1,
    Gridania = 2,
    Uldah = 3,
...
enum Client_Graphics_Render_TextureFormat /* Size=0x4 */
{
    R8G8B8A8 = 5200,
    D24S8 = 16976
};
...
enum Client_UI_Agent_AgentId /* Size=0x4 */
{
    ...
    BeginnersMansionProblem = 215,
    DpsChallenge = 216,
    PlayGuide = 217,
    WebLauncher = 218,
    WebGuidance = 219,
    Orchestrion = 220,
    BeginnerChatList = 221,
    ReturnerDialog = 224,
    OrchestrionInn = 225,
    ...
    MiragePrismPrismBox = 299,
    MiragePrismPrismItemDetail = 300,
    MiragePrismMiragePlate = 301,
    PerformanceMode = 302,
    Fashion = 305,
    SelectYesno = 307,
    ...
    MycItemBox = 378,
    MycItemBag = 379,
    MycBattleAreaInfo = 381,
    OrnamentNoteBook = 383,
    TourismMenu = 385,
...
struct Client_Game_Character_Companion /* Size=0x1C00 */
{
    /* 0x0000 */ Client_Game_Character_Character Character;
    /*        */ byte _gap_0x1B40[0xC0];
};
...
struct Client_Game_Character_Ornament /* Size=0x1B60 */
{
    /* 0x0000 */ Client_Game_Character_Character Character;
    /* 0x1B40 */ unsigned __int32 OrnamentId;
    /* 0x1B44 */ byte AttachmentPoint;
    /*        */ byte _gap_0x1B45;
    /*        */ byte _gap_0x1B46[0x2];
    /*        */ byte _gap_0x1B48[0x18];
};
...
struct Client_Game_Character_Character /* Size=0x1B40 */
{
    ...
    /* 0x01DE */ unsigned __int16 TitleID;
    } _union_0x1DE;
    /*        */ byte _gap_0x1E0[0x2];
    /* 0x01E2 */ byte ClassJob;
    /* 0x01E3 */ byte Level;
    /*        */ byte _gap_0x1E4[0x4];
    /*        */ byte _gap_0x1E8[0x4];
    /*        */ byte _gap_0x1EC;
    /* 0x01ED */ byte ShieldValue;
    /*        */ byte _gap_0x1EE;
    /* 0x01EF */ byte OnlineStatus;
    /*        */ byte _gap_0x1F0[0x2];
    /* 0x01F2 */ byte StatusFlags;
    /* 0x01F3 */ byte StatusFlags2;
    /*        */ byte _gap_0x1F4[0x4];
    /*        */ byte _gap_0x1F8[0x448];
    /*        */ byte _gap_0x640;
    /* 0x0641 */ byte CPoseState;
    /*        */ byte _gap_0x642[0x2];
    /*        */ byte _gap_0x644[0x4];
    /*        */ byte _gap_0x648[0x18];
    /* 0x0660 */ Client_Game_Character_Character_MountContainer Mount;
    /*        */ byte _gap_0x6C0[0x8];
    /* 0x06C8 */ Client_Game_Character_Character_CompanionContainer Companion;
    /* 0x06E8 */ Client_Game_Character_DrawDataContainer DrawData;
    /* 0x0878 */ Client_Game_Character_Character_OrnamentContainer Ornament;
    /*        */ byte _gap_0x8A0[0x80];
    /* 0x0920 */ Client_Game_ActionTimelineManager ActionTimelineManager;
    /*        */ byte _gap_0xC60[0x50];
    /* 0x0CB0 */ unsigned __int32 PlayerTargetObjectID;
    /*        */ byte _gap_0xCB4[0x4];
    /*        */ byte _gap_0xCB8[0xB08];
    /* 0x17C0 */ Client_Game_Balloon Balloon;
    /*        */ byte _gap_0x1840[0x188];
    /* 0x19C8 */ Client_Graphics_Vfx_VfxData* VfxData;
    /* 0x19D0 */ Client_Graphics_Vfx_VfxData* VfxData2;
    /*        */ byte _gap_0x19D8[0x20];
    /* 0x19F8 */ Client_Graphics_Vfx_VfxData* Omen;
    /*        */ byte _gap_0x1A00[0x48];
    /*        */ byte _gap_0x1A48[0x4];
    /* 0x1A4C */ float Alpha;
    /*        */ byte _gap_0x1A50[0x30];
    /* 0x1A80 */ Client_Game_Character_Companion* CompanionObject;
    /*        */ byte _gap_0x1A88[0x10];
    /* 0x1A98 */ byte FreeCompanyTag[0x6];
    /*        */ byte _gap_0x1A9E[0x2];
    /*        */ byte _gap_0x1AA0[0x18];
    /* 0x1AB8 */ unsigned __int64 TargetObjectID;
    /*        */ byte _gap_0x1AC0[0x40];
    /* 0x1B00 */ unsigned __int32 NameID;
    /*        */ byte _gap_0x1B04[0x4];
    /*        */ byte _gap_0x1B08[0x8];
    /* 0x1B10 */ unsigned __int32 CompanionOwnerID;
    /*        */ byte _gap_0x1B14[0x4];
    /*        */ byte _gap_0x1B18[0x4];
    /* 0x1B1C */ unsigned __int16 CurrentWorld;
    /* 0x1B1E */ unsigned __int16 HomeWorld;
    union {
    /* 0x1B26 */ byte EventState;
    /* 0x1B26 */ Client_Game_Character_Character_CharacterModes Mode;
    } _union_0x1B26;
    /*        */ byte _gap_0x1B21;
    /*        */ byte _gap_0x1B22[0x2];
    /*        */ byte _gap_0x1B24[0x2];
    /*        */ byte _gap_0x1B26;
    /* 0x1B27 */ byte ModeParam;
    /*        */ byte _gap_0x1B28;
    /* 0x1B29 */ byte Battalion;
    /*        */ byte _gap_0x1B2A[0x2];
    /*        */ byte _gap_0x1B2C[0x4];
    /*        */ byte _gap_0x1B30[0x8];
    /* 0x1B38 */ byte StatusFlags3;
    /*        */ byte _gap_0x1B39;
    /* 0x1B3A */ byte StatusFlags4;
    /*        */ byte _gap_0x1B3B;
    /*        */ byte _gap_0x1B3C[0x4];
};

struct Client_Game_Character_BattleChara /* Size=0x2D90 */
{
    /* 0x0000 */ Client_Game_Character_Character Character;
    /*        */ byte _gap_0x1B40[0x1250];
};
...
struct Pointer_ClientGameEventEventHandler /* Size=0x8 */
{
    /*     */ byte _gap_0x0[0x8];
};

struct StdPair_SystemUInt32_PointerClientGameEventEventHandler /* Size=0x10 */
{
    /* 0x00 */ unsigned __int32 Item1;
    /*      */ byte _gap_0x4[0x4];
    /* 0x08 */ Pointer_ClientGameEventEventHandler Item2;
};

struct StdMap_Node_SystemUInt32_PointerClientGameEventEventHandler /* Size=0x38 */
{
    /* 0x00 */ StdMap_Node_SystemUInt32_PointerClientGameEventEventHandler* Left;
    /* 0x08 */ StdMap_Node_SystemUInt32_PointerClientGameEventEventHandler* Parent;
    /* 0x10 */ StdMap_Node_SystemUInt32_PointerClientGameEventEventHandler* Right;
    /* 0x18 */ byte Color;
    /*      */ byte _gap_0x19;
    /*      */ byte _gap_0x1A[0x2];
    /* 0x1C */ bool IsNil;
    ...
    /*      */ byte _gap_0x22[0x2];
    /*      */ byte _gap_0x24[0x4];
    /* 0x28 */ StdPair_SystemUInt32_PointerClientGameEventEventHandler KeyValuePair;
};

struct StdMap_SystemUInt32_PointerClientGameEventEventHandler /* Size=0x10 */
{
    /* 0x00 */ StdMap_Node_SystemUInt32_PointerClientGameEventEventHandler* Head;
    /* 0x08 */ unsigned __int64 Count;
};
...
{
    /* 0x00 */ Client_Game_Event_ModuleBase ModuleBase;
    /* 0x40 */ StdMap_SystemUInt32_PointerClientGameEventEventHandler EventHandlerMap;
...
struct Client_Game_Housing_HousingWorkshopSubmersibleSubData /* Size=0x2320 */
{
    ...
    /*        */ byte _gap_0x5E[0x2];
    /* 0x0060 */ Client_Game_Housing_SubmarineRating Rating;
    /*        */ byte _gap_0x61;
...
struct Client_Game_InstanceContent_InstanceContentDirector /* Size=0x1CA8 */
{
    /* 0x0000 */ Client_Game_InstanceContent_ContentDirector ContentDirector;
    /*        */ byte _gap_0xC40[0x98];
    /*        */ byte _gap_0xCD8[0x4];
    /* 0x0CDC */ Client_Game_InstanceContent_InstanceContentType InstanceContentType;
    /*        */ byte _gap_0xCDD;
    /*        */ byte _gap_0xCDE[0x2];
    /*        */ byte _gap_0xCE0[0xFC8];
};
...
struct Client_Game_InstanceContent_InstanceContentDeepDungeon /* Size=0x27D8 */
{
    ...
    /*        */ byte _gap_0x1CA8[0x98];
    /* 0x1D40 */ byte Party[0x20];
    /* 0x1D60 */ byte Items[0x30];
    /* 0x1D90 */ byte Chests[0x20];
    /*        */ byte _gap_0x1DB0[0x10];
    /* 0x1DC0 */ unsigned __int32 BonusLootItemId;
    /* 0x1DC4 */ byte Floor;
    /* 0x1DC5 */ byte ReturnProgress;
    /* 0x1DC6 */ byte PassageProgress;
    /*        */ byte _gap_0x1DC7;
    /* 0x1DC8 */ byte WeaponLevel;
    /* 0x1DC9 */ byte ArmorLevel;
    /*        */ byte _gap_0x1DCA;
    /* 0x1DCB */ byte HoardCount;
    /*        */ byte _gap_0x1DCC[0x4];
    /*        */ byte _gap_0x1DD0[0xA08];
};
...
struct Client_Game_InstanceContent_PublicContentDirector /* Size=0x1088 */
{
    /* 0x0000 */ Client_Game_InstanceContent_ContentDirector ContentDirector;
    /*        */ byte _gap_0xC40[0x448];
};
...
struct Client_Game_MJI_IslandState /* Size=0xD0 */
{
    ...
    /* 0x6F */ Client_Game_MJI_MJIFarmPasture Farm;
    /* 0x73 */ Client_Game_MJI_MJIFarmPasture Pasture;
...
struct Client_Game_MJI_MJIManager /* Size=0x3F4 */
{
    /*       */ byte _gap_0x0[0x4];
    /*       */ byte _gap_0x4[0x2];
    ...
    /*       */ byte _gap_0xF8[0x18];
    /* 0x110 */ Client_Game_MJI_MJIPastureHandler* PastureHandler;
    /* 0x118 */ Client_Game_MJI_MJIFarmState* FarmState;
    /*       */ byte _gap_0x120[0x90];
    /*       */ byte _gap_0x1B0[0x4];
    /* 0x1B4 */ byte LandmarkPlacements[0x3C];
    /* 0x1F0 */ byte BuildingPlacements[0x60];
    /* 0x250 */ Client_Game_MJI_MJIBuildingPlacement CabinPlacement;
...
struct Client_Game_QuestManager_QuestListArray /* Size=0x0 */
{
};
...
{
    /*     */ byte _gap_0x0[0x90];
    /* 0x90 */ Client_Game_UI_Map_QuestMarkerArray QuestMarkers;
};
...
struct Client_Game_UI_PlayerState /* Size=0x7E8 */
{
    /* 0x000 */ byte IsLoaded;
    ...
    /*       */ byte _gap_0x2A4[0x4];
    /*       */ byte _gap_0x2A8[0x40];
    /* 0x2E8 */ byte NumOwnedMounts;
    /*       */ byte _gap_0x2E9;
    /*       */ byte _gap_0x2EA[0x2];
    /*       */ byte _gap_0x2EC[0x4];
    /*       */ byte _gap_0x2F0[0x148];
    /* 0x438 */ unsigned __int32 NumFishCaught;
    /* 0x43C */ unsigned __int32 FishingBait;
    /*       */ byte _gap_0x440[0x28];
    /*       */ byte _gap_0x468[0x4];
    /* 0x46C */ unsigned __int32 NumSpearfishCaught;
    /*       */ byte _gap_0x470[0x4];
    /* 0x474 */ byte ContentRouletteCompletion[0xC];
    /* 0x480 */ __int16 PlayerCommendations;
    /* 0x482 */ byte SelectedPoses[0x7];
    /* 0x489 */ byte PlayerStateFlags1;
    /* 0x48A */ byte PlayerStateFlags2;
    /* 0x48B */ byte PlayerStateFlags3;
    /*       */ byte _gap_0x48C[0x4];
    /*       */ byte _gap_0x490[0x78];
    /*       */ byte _gap_0x508;
    /* 0x509 */ byte UnlockFlags[0x2C];
    /*       */ byte _gap_0x535;
    /*       */ byte _gap_0x536[0x2];
    /*       */ byte _gap_0x538;
    /* 0x539 */ byte DeliveryLevel;
    /*       */ byte _gap_0x53A;
    /* 0x53B */ byte MeisterFlag;
    /*       */ byte _gap_0x53C[0x4];
    /* 0x540 */ unsigned __int32 SquadronMissionCompletionTimestamp;
    /* 0x544 */ unsigned __int32 SquadronTrainingCompletionTimestamp;
    /* 0x548 */ unsigned __int16 ActiveGcArmyExpedition;
    /* 0x54A */ unsigned __int16 ActiveGcArmyTraining;
    /*       */ byte _gap_0x54C[0x4];
    /*       */ byte _gap_0x550[0x108];
    /* 0x658 */ byte WeeklyBingoOrderData[0x10];
    /* 0x668 */ byte WeeklyBingoRewardData[0x4];
    /*       */ byte _gap_0x66C[0x4];
    /*       */ byte _gap_0x670[0x8];
    /* 0x678 */ byte WeeklyBingoRequestOpenBingoNo;
    /*       */ byte _gap_0x679;
    /*       */ byte _gap_0x67A[0x2];
    /*       */ byte _gap_0x67C[0x4];
    /*       */ byte _gap_0x680[0x30];
    /*       */ byte _gap_0x6B0[0x4];
    /* 0x6B4 */ byte WeeklyBingoExpMultiplier;
    /* 0x6B5 */ bool WeeklyBingoUnk63;
    /*       */ byte _gap_0x6B6[0x2];
    /*       */ byte _gap_0x6B8[0x90];
    /*       */ byte _gap_0x748[0x4];
    /* 0x74C */ byte MentorVersion;
    /*       */ byte _gap_0x74D;
    /*       */ byte _gap_0x74E[0x2];
    /* 0x750 */ unsigned __int32 DesynthesisLevels[0x8];
    /*       */ byte _gap_0x770[0x78];
};
...
struct Client_Game_UI_UIState /* Size=0x16BAC */
{
    ...
    /* 0x01220 */ Client_Game_UI_Revive Revive;
    ...
    /*         */ byte _gap_0x2A08[0x8];
    /* 0x02A10 */ Client_Game_UI_ContentsNote ContentsNote;
    /* 0x02AB8 */ Client_Game_UI_RelicNote RelicNote;
    /*         */ byte _gap_0x2AD0[0x48];
    /* 0x02B18 */ Client_Game_UI_AreaInstance AreaInstance;
    /*         */ byte _gap_0x2B40[0x4A0];
    /* 0x02FE0 */ Client_Game_UI_Loot Loot;
    /*         */ byte _gap_0x3680[0x600];
    /* 0x03C80 */ Client_Game_UI_RecipeNote RecipeNote;
    /*         */ byte _gap_0x4290[0x6570];
    /* 0x0A800 */ Client_Game_Event_Director* ActiveDirector;
    /*         */ byte _gap_0xA808[0x140];
    /* 0x0A948 */ Client_Game_Fate_FateDirector* FateDirector;
    /*         */ byte _gap_0xA950[0x140];
    /* 0x0AA90 */ Client_Game_UI_Map Map;
    /*         */ byte _gap_0xAA90[0x3FF0];
    /* 0x0EA80 */ Client_Game_UI_MarkingController MarkingController;
    /* 0x0ED60 */ Client_Game_UI_LimitBreakController LimitBreakController;
    /*         */ byte _gap_0xED70[0x2CB8];
    /* 0x11A28 */ Client_Game_UI_RouletteController RouletteController;
    /*         */ byte _gap_0x11A98[0x60];
    /* 0x11AF8 */ Client_Game_UI_ContentsFinder ContentsFinder;
    /*         */ byte _gap_0x11BA8[0x68];
    /* 0x11C10 */ Client_Game_UI_MobHunt MobHunt;
    /*         */ byte _gap_0x11DA8[0x4D48];
    /*         */ byte _gap_0x16AF0[0x4];
    /* 0x16AF4 */ byte UnlockLinkBitmask[0x40];
    /* 0x16B34 */ byte UnlockedAetherytesBitmask[0x19];
    /*         */ byte _gap_0x16B4D;
...
struct FFXIVClientStructs_Havok_hkBaseObject_hkBaseObjectVtbl /* Size=0x0 */
{
    /* 0x0 */ void* dtor;
    /* 0x8 */ void* __first_virtual_table_function__;
};

struct FFXIVClientStructs_Havok_hkBaseObject /* Size=0x0 */
{
...
struct FFXIVClientStructs_Havok_hkStringPtr /* Size=0x0 */
{
    /* 0x0 */ byte* StringAndFlag;
};

struct FFXIVClientStructs_Havok_hkArray_SystemInt16 /* Size=0x10 */
{
    /* 0x00 */ __int16* Data;
    /* 0x08 */ __int32 Length;
...
struct FFXIVClientStructs_Havok_hkaBone /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkStringPtr Name;
    /*     */ byte _gap_0x0[0x8];
    /* 0x8 */ byte LockTranslation;
};

struct FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaBone /* Size=0x10 */
{
...
struct FFXIVClientStructs_Havok_hkVector4f /* Size=0x0 */
{
    /* 0x0 */ float X;
    /* 0x4 */ float Y;
    /* 0x8 */ float Z;
...
struct FFXIVClientStructs_Havok_hkQuaternionf /* Size=0x0 */
{
    /* 0x0 */ float X;
    /* 0x4 */ float Y;
    /* 0x8 */ float Z;
...
struct FFXIVClientStructs_Havok_hkQsTransformf /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkVector4f Translation;
    /*     */ byte _gap_0x0[0x10];
...
struct FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkQsTransformf /* Size=0x10 */
{
...
struct FFXIVClientStructs_Havok_hkArray_SystemSingle /* Size=0x10 */
{
    /* 0x00 */ float* Data;
    /* 0x08 */ __int32 Length;
    /* 0x0C */ __int32 CapacityAndFlags;
...
struct FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkStringPtr /* Size=0x10 */
{
...
struct FFXIVClientStructs_Havok_hkLocalFrame /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkReferencedObject hkReferencedObject;
};

struct FFXIVClientStructs_Havok_hkRefPtr_FFXIVClientStructsHavokhkLocalFrame /* Size=0x8 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkLocalFrame* ptr;
};

struct FFXIVClientStructs_Havok_hkaSkeleton_LocalFrameOnBone /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkRefPtr_FFXIVClientStructsHavokhkLocalFrame LocalFrame;
    /* 0x8 */ __int16 BoneIndex;
};

struct FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaSkeletonLocalFrameOnBone /* Size=0x10 */
{
...
struct FFXIVClientStructs_Havok_hkaSkeleton_Partition /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkStringPtr Name;
    /*     */ byte _gap_0x0[0x8];
    /* 0x8 */ __int16 StartBoneIndex;
    /* 0xA */ __int16 NumBones;
};

struct FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaSkeletonPartition /* Size=0x10 */
{
...
struct FFXIVClientStructs_Havok_hkaSkeleton /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkReferencedObject hkReferencedObject;
    /* 0x10 */ FFXIVClientStructs_Havok_hkStringPtr Name;
    /*     */ byte _gap_0x10[0x8];
    /* 0x18 */ FFXIVClientStructs_Havok_hkArray_SystemInt16 ParentIndices;
    /* 0x28 */ FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaBone Bones;
    /* 0x38 */ FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkQsTransformf ReferencePose;
    /* 0x48 */ FFXIVClientStructs_Havok_hkArray_SystemSingle ReferenceFloats;
    /* 0x58 */ FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkStringPtr FloatSlots;
    /* 0x68 */ FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaSkeletonLocalFrameOnBone LocalFrames;
    /* 0x78 */ FFXIVClientStructs_Havok_hkArray_FFXIVClientStructsHavokhkaSkeletonPartition Partitions;
};

struct Pointer_FFXIVClientStructsHavokhkaSkeletonMapper /* Size=0x8 */
{
    /*     */ byte _gap_0x0[0x8];
};

struct StdPair_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper /* Size=0x10 */
{
    /* 0x00 */ unsigned __int32 Item1;
    /*      */ byte _gap_0x4[0x4];
    /* 0x08 */ Pointer_FFXIVClientStructsHavokhkaSkeletonMapper Item2;
};

struct StdMap_Node_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper /* Size=0x38 */
{
    /* 0x00 */ StdMap_Node_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper* Left;
    /* 0x08 */ StdMap_Node_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper* Parent;
    /* 0x10 */ StdMap_Node_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper* Right;
    /* 0x18 */ byte Color;
    /*      */ byte _gap_0x19;
    /*      */ byte _gap_0x1A[0x2];
    /* 0x1C */ bool IsNil;
    ...
    /*      */ byte _gap_0x22[0x2];
    /*      */ byte _gap_0x24[0x4];
    /* 0x28 */ StdPair_SystemUInt32_PointerFFXIVClientStructsHavokhkaSkeletonMapper KeyValuePair;
};
...
struct Pointer_FFXIVClientStructsHavokhkResource /* Size=0x8 */
{
    /*     */ byte _gap_0x0[0x8];
};

struct FFXIVClientStructs_Havok_hkArray_PointerFFXIVClientStructsHavokhkResource /* Size=0x10 */
{
    /* 0x00 */ Pointer_FFXIVClientStructsHavokhkResource* Data;
    /* 0x08 */ __int32 Length;
    /* 0x0C */ __int32 CapacityAndFlags;
};

struct FFXIVClientStructs_Havok_hkLoader /* Size=0x0 */
{
    /* 0x0 */ FFXIVClientStructs_Havok_hkReferencedObject hkReferencedObject;
    /* 0x10 */ FFXIVClientStructs_Havok_hkArray_PointerFFXIVClientStructsHavokhkResource LoadedData;
};
...
struct Client_Graphics_Render_Material /* Size=0x20 */
{
...
struct Client_Graphics_Render_Manager /* Size=0x2D730 */
{
    /* 0x00000 */ void* Vtbl;
...
struct Client_UI_UIModule /* Size=0xEC1E0 */
{
    union {
    /* 0x00000 */ void* vtbl;
    /* 0x00000 */ void** vfunc;
...
struct Component_GUI_AtkLinkedList_Node_PointerComponentGUIAtkUldManagerDuplicateObjectList /* Size=0x18 */
{
    /* 0x00 */ Pointer_ComponentGUIAtkUldManagerDuplicateObjectList Value;
    /* 0x08 */ Component_GUI_AtkLinkedList_Node_PointerComponentGUIAtkUldManagerDuplicateObjectList* Next;
    /* 0x10 */ Component_GUI_AtkLinkedList_Node_PointerComponentGUIAtkUldManagerDuplicateObjectList* Previous;
};
...
struct Component_GUI_AtkUnitBase_AtkUnitBaseVTable /* Size=0x0 */
{
    ...
    /*     */ byte _gap_0x180[0x10];
    /* 0x190 */ __int64 OnUpdate;
};
...
struct Client_UI_AddonNeedGreed /* Size=0x2B8 */
{
    /* 0x000 */ Component_GUI_AtkUnitBase AtkUnitBase;
    /*       */ byte _gap_0x220[0x8];
...
struct Client_UI_Misc_CharaView /* Size=0x2C8 */
{
    ...
    /*       */ byte _gap_0xC4[0x4];
    /*       */ byte _gap_0xC8[0x8];
    /* 0x0D0 */ Client_UI_Misc_CharaView_UnkStruct UnkD0;
    /* 0x0F0 */ Client_UI_Misc_CharaView_UnkStruct UnkF0;
    /* 0x110 */ Client_UI_Misc_CharaView_UnkStruct Unk110;
    /* 0x130 */ Client_UI_Misc_CharaView_UnkStruct Unk130;
    /* 0x150 */ Client_UI_Misc_CharaView_UnkStruct Unk150;
    /* 0x170 */ Client_UI_Misc_CharaView_UnkStruct Unk170;
    /* 0x190 */ Client_UI_Misc_CharaView_UnkStruct Unk190;
    /*       */ byte _gap_0x1B0[0xE0];
    /* 0x290 */ unsigned __int64 Unk290;
    /* 0x298 */ unsigned __int64 Unk298;
    /* 0x2A0 */ unsigned __int64 Unk2A0;
    /* 0x2A8 */ unsigned __int64 Unk2A8;
...
struct Client_UI_Agent_AgentContentsFinder /* Size=0x2088 */
{
...
struct Client_UI_Agent_AgentGrandCompanySupply /* Size=0x2F8 */
{
    /* 0x000 */ Component_GUI_AgentInterface AgentInterface;
    /*       */ byte _gap_0x28[0x38];
    /* 0x060 */ Client_UI_Agent_SupplyProvisioningData* SupplyProvisioningData;
    /* 0x068 */ Client_UI_Agent_GrandCompanyItem* ItemArray;
    /*       */ byte _gap_0x70[0x8];
...
struct Client_UI_Agent_AgentInventoryContext /* Size=0x678 */
{
    ...
    union {
    /* 0x5D0 */ Client_Game_InventoryType TargetInventoryId;
    /* 0x5D0 */ Client_Game_InventoryType BlockedInventoryId;
    } _union_0x5D0;
    union {
...
struct Client_UI_Agent_AgentLobby /* Size=0x1DD0 */
{
    /* 0x0000 */ Component_GUI_AgentInterface AgentInterface;
    /*        */ byte _gap_0x28[0x10C0];
    /* 0x10E8 */ unsigned __int64 SelectedCharacterId;
    /* 0x10F0 */ byte DataCenter;
    /*        */ byte _gap_0x10F1;
    /*        */ byte _gap_0x10F2[0x2];
...
struct Client_UI_Agent_AgentMap /* Size=0x11F70 */
{
    ...
    /*         */ byte _gap_0x5968[0x8];
    /*         */ byte _gap_0x5970[0x4];
    /* 0x05974 */ unsigned __int32 UpdateFlags;
    /*         */ byte _gap_0x5978[0x98];
    /*         */ byte _gap_0x5A10[0x2];
    /* 0x05A12 */ byte MapMarkerCount;
    /* 0x05A13 */ byte TempMapMarkerCount;
    /*         */ byte _gap_0x5A14;
    /* 0x05A15 */ byte IsFlagMarkerSet;
    /*         */ byte _gap_0x5A16;
    /* 0x05A17 */ byte MiniMapMarkerCount;
    /*         */ byte _gap_0x5A18[0x4];
    /*         */ byte _gap_0x5A1C[0x2];
    /*         */ byte _gap_0x5A1E;
    /* 0x05A1F */ byte IsPlayerMoving;
    /*         */ byte _gap_0x5A20[0x4];
...
struct Client_UI_Agent_AgentModule /* Size=0xDB8 */
{
    /* 0x000 */ void* vtbl;
    ...
    /*       */ byte _gap_0x1C[0x4];
    /* 0x020 */ byte Agents[0xD80];
    /*       */ byte _gap_0xDA0[0x8];
    /* 0xDA8 */ Client_UI_UIModule* UIModulePtr;
    /* 0xDB0 */ Client_UI_Agent_AgentModule* AgentModulePtr;
};
...
struct Client_UI_Info_InfoProxyCommonList_CharacterArray_Entry /* Size=0x60 */
{
    ...
    /* 0x1C */ Client_UI_Agent_GrandCompany GrandCompany;
...
struct Client_UI_Info_InfoProxyCommonList_CharacterDict /* Size=0x318 */
{
    /* 0x000 */ byte Entries[0x2000];
};
...
struct Client_UI_Misc_ConfigModule /* Size=0xE348 */
{
    /*        */ byte _gap_0x0[0x28];
    /* 0x0028 */ Client_UI_UIModule* UIModule;
    /*        */ byte _gap_0x30[0xE318];
};
...
struct StdVector_ClientUIMiscItemOrderModuleSorterItemEntry /* Size=0x18 */
{
...
struct Client_UI_Misc_ItemOrderModuleSorter /* Size=0x60 */
{
    ...
    /*      */ byte _gap_0x4[0x4];
    /* 0x08 */ StdVector_ClientUIMiscItemOrderModuleSorterItemEntry Items;
    /*      */ byte _gap_0x20[0x8];
...
struct Client_UI_Misc_ItemOrderModule /* Size=0xD8 */
{
    ...
    /* 0xB8 */ StdVector_ClientUIMiscItemOrderModuleSorterRetainerEntry* RetainerSorter;
...
struct Client_UI_RaptureAtkModule /* Size=0x28C80 */
{
    /*         */ byte _gap_0x0[0x10A70];
    /* 0x10A70 */ Client_System_String_Utf8String* AddonNames;
    /*         */ byte _gap_0x10A78[0xD8];
    /* 0x10B50 */ Client_UI_Agent_AgentModule AgentModule;
    /*         */ byte _gap_0x11908[0x8];
    /* 0x11910 */ Client_UI_RaptureAtkUnitManager RaptureAtkUnitManager;
    /*         */ byte _gap_0x1B620[0x280];
    /* 0x1B8A0 */ __int32 NameplateInfoCount;
    /*         */ byte _gap_0x1B8A4[0x4];
    /* 0x1B8A8 */ Client_UI_RaptureAtkModule_NamePlateInfo NamePlateInfoArray;
    /*         */ byte _gap_0x1BAF0[0xD148];
    /* 0x28C38 */ Component_GUI_AtkTexture CharaViewDefaultBackgroundTexture;
    /*         */ byte _gap_0x28C50[0x30];
};
...
struct Component_GUI_AtkModule /* Size=0x8250 */
{
    union {
    /* 0x0000 */ void* vtbl;
    ...
    /*        */ byte _gap_0x130[0x100];
    /* 0x0230 */ Component_Exd_ExdModule* ExdModule;
    /*        */ byte _gap_0x238[0x30];
    /* 0x0268 */ Client_UI_RaptureAtkUnitManager* RaptureAtkUnitManager;
    /*        */ byte _gap_0x270[0x18A0];
