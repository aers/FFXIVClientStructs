...
NameAddr(0x1401ACF20, "ResourceManager::GetResourceAsync") # no vtbl on this class wouldnt be surprised if it was Client::System::Resource::ResourceManager or something though
NameAddr(0x1401AD140, "ResourceManager::GetResourceSync")
...
NameAddr(0x140318C20, "ctor_Client::Graphics::Render::GraphicsConfig")
NameAddr(0x140322600, "ctor_Client::Graphics::Render::AmbientLight")
NameAddr(0x140324570, "ctor_Client::Graphics::Render::Model")
NameAddr(0x1403246C0, "Client::Graphics::Render::Model_SetupFromModelResourceHandle")
NameAddr(0x14035C620, "ctor_Client::Graphics::Render::RenderManager")
NameAddr(0x14035D800, "Client::Graphics::Render::RenderManager_CreateModel")
NameAddr(0x14035EAE0, "ctor_Client::Graphics::Render::ShadowManager")
NameAddr(0x140363110, "ctor_Client::Graphics::Render::LightingManager::LightingRenderer")
NameAddr(0x14036D9C0, "ctor_Client::Graphics::Render::LightingManager")
NameAddr(0x14036E1A0, "ctor_Client::Graphics::Render::RenderTargetManager")
NameAddr(0x14038EF50, "ctor_Client::Graphics::PostEffect::PostEffectManager")
NameAddr(0x140424850, "Client::Graphics::Scene::DrawObject_ctor")
NameAddr(0x140424E00, "ctor_Client::Graphics::Scene::World")
NameAddr(0x1404250C0, "ctor_Client::Graphics::Scene::Camera")
NameAddr(0x140426B90, "ctor_Client::Graphics::Scene::CameraManager")
...
NameAddr(0x140A6BA20, "EventFramework::GetSingleton")
