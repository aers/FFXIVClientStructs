...
public class ExporterIDAOld : ExporterBaseOld {
    public ExporterIDAOld() : base("::") {
    }
...
public class ExporterGhidraOld : ExporterBaseOld {
    public ExporterGhidraOld() : base("_") {
    }
...
public abstract class ExporterBaseOld {
    ...
    protected ExporterBaseOld(string separator) {
    ...
    public string Export(GapStrategy gapStrategy) {
        ...
        var definedTypes = ExporterStatics.GetXIVTypes().OrderBy(t => t.FullName).ToArray();
