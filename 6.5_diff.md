...
As of commit 0af185ef155cf03f24c2dee8f50f3973a7d417aa:
...
Client/UI/Info/InfoProxyCommonList.cs:
 ...
 - Moved OnlineStatus, MentorState, PartyStatu, DutyStatus to single OnlineStatus enum linked to bitflag of OnlineStatus.exd
 - Added Sort field
