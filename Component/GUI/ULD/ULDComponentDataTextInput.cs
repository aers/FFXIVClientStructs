...
namespace FFXIVClientStructs.Component.GUI.ULD
{
    ...
    public unsafe struct ULDComponentDataTextInput
    {
        [FieldOffset(0x00)] public ULDComponentDataInputBase InputBase;
        [FieldOffset(0x10)] public fixed uint Nodes[16];
        [FieldOffset(0x50)] public FFXIVByteColor CandidateColor;
        [FieldOffset(0x54)] public FFXIVByteColor IMEColor;
