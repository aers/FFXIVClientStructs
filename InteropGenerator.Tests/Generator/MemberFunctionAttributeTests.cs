    ...
    public async Task GenerateMemberFunctionInNamespace() {
        ...
        const string result = """
                              ...
                              unsafe partial struct TestStruct
                              {
                                  public static class Addresses
                                  {
                                      public static readonly Address TestFunction = new Address("TestNamespace.InnerNamespace.TestStruct.TestFunction", "AA BB CC DD ?? ?? ?? ?? AA BB ?? DD ?? ?? ?? ??", new ulong[] {0x00000000DDCCBBAA, 0x00000000DD00BBAA}, new ulong[] {0x00000000FFFFFFFF, 0x00000000FF00FFFF}, 0);
                                  }
                                  public unsafe static class MemberFunctionPointers
                                  {
                                      public static delegate* unmanaged[Stdcall] <TestStruct*, int, void*, int> TestFunction => (delegate* unmanaged[Stdcall] <TestStruct*, int, void*, int>) TestStruct.Addresses.TestFunction.Value;
        ...
        const string result = """
                              ...
                              unsafe partial struct TestStruct
                              {
                                  unsafe partial struct InnerStruct
                                  {
                                      public static class Addresses
                                      {
                                          public static readonly Address TestFunction = new Address("TestStruct+InnerStruct.TestFunction", "AA BB CC DD ?? ?? ?? ?? AA BB ?? DD ?? ?? ?? ??", new ulong[] {0x00000000DDCCBBAA, 0x00000000DD00BBAA}, new ulong[] {0x00000000FFFFFFFF, 0x00000000FF00FFFF}, 0);
                                      }
                                      public unsafe static class MemberFunctionPointers
                                      {
