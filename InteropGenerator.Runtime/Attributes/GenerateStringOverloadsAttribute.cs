...
///
/// Native functions often take C-string arguments - a byte pointer to a null terminated string. This attribute will generate method overloads to ease calling these functions.
///
/// Generates two overloads, one taking C# string objects and one taking ReadOnlySpan&lt;byte> structs in place of the byte pointers.
///
