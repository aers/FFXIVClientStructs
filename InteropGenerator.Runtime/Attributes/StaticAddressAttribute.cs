...
///
/// The stub should return a pointer to the type at the static address. If the type at the static address is a pointer, set isPointer true and leave the return type as a single pointer.
/// </summary>
