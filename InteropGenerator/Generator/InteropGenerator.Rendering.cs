        ...
        foreach (BitFieldInfo bitField in structInfo.BitFields) {
            ...
            using (writer.WriteBlock()) {
                if (bitField.Type == "bool") {
                    ...
                    if (bitField.HasSetter) writer.WriteLine($"set => BitOps.SetBit<{bitField.BackingType}>({bitField.FieldName}, {bitField.Index}, value);");
                }
                else {
                    ...
                    if (bitField.HasSetter) writer.WriteLine($"set => BitOps.SetBits<{bitField.BackingType}>({bitField.FieldName}, {bitField.Index}, {mask}, ({bitField.BackingType})value);");
                }
            }
        }
    }
