...
public sealed partial class InteropGenerator {
    ...
    private static string RenderResolverInitializer(ImmutableArray<StructInfo> structInfos) {
        using IndentedTextWriter writer = new();
        // write file header
        writer.WriteLine("// <auto-generated/>");
        writer.WriteLine("namespace InteropGenerator.Runtime.Generated;");
        writer.WriteLine("public static class Addresses");
        using (writer.WriteBlock()) {
    ...
    private static string RenderFixedArrayTypes(ImmutableArray<StructInfo> structInfos) {
        using IndentedTextWriter writer = new();
